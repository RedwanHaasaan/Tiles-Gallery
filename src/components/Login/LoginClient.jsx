      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className={`w-full max-w-md ${shake ? "animate__animated animate__shakeX" : "animate__animated animate__fadeInUp"}`}>
          ...
          <div className="text-center lg:text-left mb-8">
            <h1 className="text-3xl font-bold text-espresso mb-2">Log In</h1>
            <p className="text-ash">{"Don't have an account? "}
          ...
          <button type="button" onClick={handleGoogleSignIn} disabled={isGoogleLoading}
            className="btn btn-outline w-full border-tile-border text-espresso hover:bg-stone hover:border-stone mb-6 hover:scale-[1.02] transition-transform duration-200">
          ...
          <div className="divider text-ash text-sm">or Log in with email</div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button type="submit" disabled={isLoading}
              className="btn w-full bg-espresso text-white hover:bg-gold border-none transition-all duration-300 hover:scale-[1.02] animate__animated animate__fadeIn stagger-4"
