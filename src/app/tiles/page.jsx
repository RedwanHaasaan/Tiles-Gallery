...
function TilesLoading() {
  return (
    <div className="space-y-6">
      {/* Search skeleton */}
      <div className="bg-white rounded-xl shadow-sm border border-[#e0dcd6] p-6">
        <div className="h-12 bg-[#e8e4df] rounded-lg animate-pulse"></div>
      </div>
      
      {/* Grid skeleton */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {[...Array(8)].map((_, i) => (
          <div key={i} className="bg-white rounded-xl shadow-sm border border-[#e0dcd6] overflow-hidden">
            <div className="h-48 bg-[#e8e4df] animate-pulse"></div>
            <div className="p-4 space-y-3">
              <div className="h-5 bg-[#e8e4df] rounded animate-pulse"></div>
              <div className="h-4 bg-[#e8e4df] rounded w-3/4 animate-pulse"></div>
              <div className="h-10 bg-[#e8e4df] rounded animate-pulse"></div>
            </div>
          </div>
        ))}
      </div>
...
export default function TilesPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#f8f6f3]">
      ...
      {/* Page Header */}
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-[#2d2926]">
