    ...
    <div className="min-h-screen flex bg-[#f8f6f3]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-linear-to-r from-[#2d2926]/80 to-transparent" />
        <div className="absolute inset-0 flex items-center justify-start p-12">
          <div className="max-w-md text-white">
            ...
            <p className="text-gray-300 text-lg">
              Log in to access your account and explore our premium tile
              collection.
            </p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="btn btn-outline w-full border-[#e0dcd6] text-[#2d2926] hover:bg-[#e8e4df] hover:border-[#e8e4df] mb-6"
          >
           {isGoogleLoading ? (
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input input-bordered w-full pl-12 pr-12 bg-white border-[#e0dcd6]"
                />
                <button
                  type="button"
